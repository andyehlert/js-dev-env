/*
    ...
    in the production builds only. A separate bundle for vendor
    code is usefult since it's unlikely to change as often
    ...
    Any files that aren't referenced hee will be bundled into
